...
Collisions::Collisions() : Module()
{
	...
	matrix[Collider::Type::SNOWBALL][Collider::Type::ENEMY] = true;
	...
	matrix[Collider::Type::CHEKPOINT][Collider::Type::ENEMY] = false;
	...
	matrix[Collider::Type::LIFE][Collider::Type::ENEMY] = false;
